...
AppSoftwareCtrl.$inject = ['$scope', 'FactoryService', '$location', 'CategoriaService', '$routeParams', 'PaginatorService'];
function AppSoftwareCtrl($scope, FactoryService, $location, CategoriaService, $routeParams, PaginatorService) {
    ...
    if ($routeParams !== undefined && $routeParams.empresa_id !== undefined) {
        $scope.software.empresa_id = parseInt($routeParams.empresa_id);
    }
